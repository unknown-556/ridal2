...
mapboxgl.accessToken =
    "pk.eyJ1IjoidGhhdG5vYWhib3kiLCJhIjoiY2x1eW8yMzN3MHR3ZjJpcXJnNnJkaWRhdiJ9.3M6uKuIgKbIMY55BDFdr6Q";
...
navigator.clipboard.writeText(bankDetails).then(
    function () {
        ...
        setTimeout(function () {
            document.getElementById("copyButton").innerText = "Copy Bank Details";
